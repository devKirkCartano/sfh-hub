...
app.get(`${pathPrefix}/register`, checkAuthenticatedAdmin, preventCaching, (req, res) => {
  res.render("register-admin1.ejs", { error: req.flash('error'), success: req.flash('success') });
});
...
app.get('/getLoggedInAdminName', checkAuthenticatedAdmin, async (req, res) => {
...
// Login endpoint
app.post(`${pathPrefix}/login`, checkNotAuthenticatedAdmin, passport.authenticate('admin', {
